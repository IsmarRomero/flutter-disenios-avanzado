...
class _Dot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
        ...
        width:  isCurrent ? slideShowModel.bulletPrimario : slideShowModel.bulletSecundario,
        height: isCurrent ? slideShowModel.bulletPrimario : slideShowModel.bulletSecundario,
